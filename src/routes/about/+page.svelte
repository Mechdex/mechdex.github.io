...
>
	...
	<article class="w-full h-full prose text-on-surface-token">
        ...
        <p>Also, yes, the initial mechanics data was generated by AI. I'm very sorry to have had to do this, but there's no way I could write placeholders for 22x5 = 110 mechanics myself. These will be slowly phased out for human-written content.</p>
